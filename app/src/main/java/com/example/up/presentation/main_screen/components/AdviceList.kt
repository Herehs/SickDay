    ...
    LazyColumn() {
        items(advices){ advice ->
            Row(
                ...
                Icon(painter = painterResource(advice.icon), contentDescription = null)
                Text(
...
@Composable
fun AdviceListTest(){
    val advice = Advice(icon = R.drawable.heart_rate, text = "kakoy-to text kakoy-to text kakoy-to text kakoy-to text kakoy-to text kakoy-to text kakoy-to text kakoy-to text kakoy-to text kakoy-to text ")
