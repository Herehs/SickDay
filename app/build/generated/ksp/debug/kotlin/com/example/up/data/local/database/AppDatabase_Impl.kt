...
internal class AppDatabase_Impl : AppDatabase() {
  ...
  protected override fun createOpenDelegate(): RoomOpenDelegate {
    val _openDelegate: RoomOpenDelegate = object : RoomOpenDelegate(5, "6312c2dd52b35709159c6d4ee149fba7", "f4f9d62b08d7a0aef9a626f5f40ad6b5") {
      public override suspend fun createAllTables(connection: SQLiteConnection) {
        connection.execSQL("CREATE TABLE IF NOT EXISTS `notes` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `date` INTEGER NOT NULL, `generalHealth` REAL NOT NULL, `note` TEXT NOT NULL, `drowsiness` REAL NOT NULL, `pressure` REAL NOT NULL, `weakness` REAL NOT NULL)")
        connection.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)")
        connection.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '6312c2dd52b35709159c6d4ee149fba7')")
      }
      ...
      public override suspend fun onValidateSchema(connection: SQLiteConnection): RoomOpenDelegate.ValidationResult {
        ...
        _columnsNotes.put("generalHealth", TableInfo.Column("generalHealth", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY))
        _columnsNotes.put("note", TableInfo.Column("note", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY))
        _columnsNotes.put("drowsiness", TableInfo.Column("drowsiness", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY))
        _columnsNotes.put("pressure", TableInfo.Column("pressure", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY))
        _columnsNotes.put("weakness", TableInfo.Column("weakness", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY))
